...
function GradientBackground() {
  return (
    <div className="fixed top-0 w-full h-3/5 overflow-hidden">
      <div className="absolute w-full h-full bg-gradient-to-t from-pink-50 z-10" />
      ...
      >
        ...
        <g clipPath="url(#a)">
          ...
          <path d="M960 0H0v743h960V0Z" fill="#B190B1" />
          <path
  ...
  return (
    <Layout hero={<GradientBackground />}>
      <div className="relative mb-12">
        <Welcome />
        <div className="bg-white p-12 shadow-xl rounded mb-10">
          {featuredProductsCollection ? (
            <>
              <div className="flex justify-between items-center mb-8 text-md font-medium">
                
                <span className="hidden lowercase md:inline-flex ">
                  <Link
